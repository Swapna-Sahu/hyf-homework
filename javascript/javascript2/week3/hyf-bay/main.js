...
/************************ Sorting************************************************/
var sortByRate = document.querySelector("select");
sortByRate.setAttribute('id', "select_sort");
sortByRate.setAttribute('value', "");
sortByRate.setAttribute('onchange', "sortProduct(this.value)");
var selectSort = document.getElementById("select_sort").value;
console.log(selectSort);

function sortProduct (val) {
    console.log("The input location has changed. The new location is: " + val);
    var selectedSort = val.charAt(0).toUpperCase() + val.slice(1);
    console.log(selectedSort);
    if(selectedSort === "Expensive") { 
        var ascOrderExpensive = products.sort((a, b) => a.price < b.price ? 1 : -1);
        console.log(ascOrderExpensive);
        renderProducts(ascOrderExpensive); }
    if (selectedSort === "Cheap") {
        var ascOrderCheap = products.sort((a, b) => a.price < b.price ? -1 : 1 );
        console.log(ascOrderCheap);
        renderProducts(ascOrderCheap);
    }
    if (selectedSort === "Name") { 
        var ascOrderName = products.sort((a, b) => a.name > b.name ? 1 : -1);
        console.log(ascOrderName);
        renderProducts(ascOrderName);}
}
...
function myFunction(product) {
    ...
    var total = document.querySelector(".total p span");
